...
public class ModBlocks {
    ...
    public static final RegistryObject<Block> WARPED_POLISHED_NETHERRACK = registerBlock("warped_polished_netherrack",
            () -> new Block(BlockBehaviour.Properties.copy(Blocks.TUFF).sound(SoundType.NETHERRACK)));
    ...
    public static final RegistryObject<Block> WARPED_POLISHED_NETHERRACK_STAIRS = registerBlock("warped_polished_netherrack_stairs",
            () -> new StairBlock(() -> ModBlocks.WARPED_POLISHED_NETHERRACK.get().defaultBlockState(),
                    BlockBehaviour.Properties.copy(Blocks.TUFF).sound(SoundType.NETHERRACK)));
    public static final RegistryObject<Block> WARPED_POLISHED_NETHERRACK_SLAB = registerBlock("warped_polished_netherrack_slab",
            () -> new SlabBlock(BlockBehaviour.Properties.copy(Blocks.TUFF).sound(SoundType.NETHERRACK)));
    ...
    public static final RegistryObject<Block> WARPED_POLISHED_NETHERRACK_WALL = registerBlock("warped_polished_netherrack_wall",
            () -> new WallBlock(BlockBehaviour.Properties.copy(Blocks.TUFF).sound(SoundType.NETHERRACK)));
    ...
    public static final RegistryObject<Block> WARPED_NETHERRACK_PLATE = registerBlock("warped_netherrack_pressure_plate",
            () -> new PressurePlateBlock(PressurePlateBlock.Sensitivity.EVERYTHING, BlockBehaviour.Properties.copy(Blocks.STONE).sound(SoundType.STONE),
                    BlockSetType.STONE));
    public static final RegistryObject<Block> WARPED_POLISHED_NETHERRACK_BUTTON = registerBlock("warped_polished_netherrack_button",
            () -> new ButtonBlock(BlockBehaviour.Properties.copy(Blocks.STONE_BUTTON).sound(SoundType.STONE),
                    BlockSetType.STONE, 10, true));
    public static final RegistryObject<Block> WARPED_POLISHED_NETHERRACK_PLATE = registerBlock("warped_polished_netherrack_pressure_plate",
            () -> new PressurePlateBlock(PressurePlateBlock.Sensitivity.EVERYTHING, BlockBehaviour.Properties.copy(Blocks.STONE).sound(SoundType.STONE),
                    BlockSetType.STONE));

    public static final RegistryObject<Block> WARPED_CHISELED_NETHERRACK = registerBlock("warped_chiseled_netherrack",
