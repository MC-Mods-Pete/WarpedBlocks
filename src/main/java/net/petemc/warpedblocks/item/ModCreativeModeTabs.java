    ...
    public static final RegistryObject<CreativeModeTab> WARPED_BLOCK_TAB = CREATIVE_MODE_TABS.register("warped_blocks_tab",
            () -> CreativeModeTab.builder().icon(() -> new ItemStack(ModBlocks.WARPED_NETHERRACK.get()))
                    ...
                    .displayItems((pParameters, pOutput) -> {
                        ...
                        pOutput.accept(ModBlocks.WARPED_CHISELED_NETHERRACK.get());
                        pOutput.accept(ModBlocks.WARPED_POLISHED_NETHERRACK.get());
                        pOutput.accept(ModBlocks.WARPED_POLISHED_NETHERRACK_STAIRS.get());
                        pOutput.accept(ModBlocks.WARPED_POLISHED_NETHERRACK_SLAB.get());
                        pOutput.accept(ModBlocks.WARPED_POLISHED_NETHERRACK_WALL.get());
                        pOutput.accept(ModBlocks.WARPED_POLISHED_NETHERRACK_BUTTON.get());
                        pOutput.accept(ModBlocks.WARPED_POLISHED_NETHERRACK_PLATE.get());
